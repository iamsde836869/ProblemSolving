...
// Java program for recursive
// Tower of Hanoi
/*public class TowerOfHanoi {
    static void tOH(int n, char fRom    ,char tO, char aRbitrary){
                    if(n==1){
                        System.out.println("move disk 1 " + " from " + fRom +" to " + tO);
                        return;
                    }
        tOH(n-1,fRom,aRbitrary,tO);
        System.out.println("move disk " + n + " from " + fRom +" to " + tO);
        tOH(n-1,aRbitrary,tO,fRom);
    }
    public static void main(String args[]){
        int n=10;// 4 plates in the first tower logic:fta,fat,atf
        tOH(n,'A','C','B');
    }
}
